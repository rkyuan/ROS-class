...
private:
    ...
    ros::Publisher  jnt_cmd_publisher_,jnt_cmd_publisher_2; // need a publisher to talk to the joint controller
   ...
   as_(nh_, "example_traj_action_server", boost::bind(&TrajectoryActionServer::executeCB, this, _1),false) 
{
    ...
    jnt_cmd_publisher_2 = nh_.advertise<std_msgs::Float64>("pos_cmd2", 1, true); 
...
void  TrajectoryActionServer::send_joint_commands_(vector <double> q_cmd_jnts) { 
    ...
    jnt_cmd_publisher_2.publish(q_cmd_msg);
