...
void PlaneFitter::fit_points_to_plane(Eigen::MatrixXd points_mat,Eigen::Vector3d &plane_normal, double &plane_dist) {
...
void PlaneFitter::generate_planar_points(Eigen::Vector3d normal_vec,double dist,int npts, double noise_gain,Eigen::MatrixXd &points_array) {
   Eigen::Vector3d v1,v2; //need to fill in values for these
    ...
    points_array = points_array + Noise*noise_gain;  
